  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-ink/70 backdrop-blur-2xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8" aria-label="Main navigation">
        ...
        <div className="hidden items-center rounded-full border border-white/10 bg-white/6 p-1 lg:flex">
        ...
        <a
          href="#booking"
          className="hidden rounded-full border border-cyan/30 bg-cyan/10 px-5 py-2.5 text-sm font-semibold text-cyan transition hover:bg-cyan hover:text-ink md:inline-flex"
        >
          {cta}
        </a>
      ...
      {open ? (
        <div className="border-t border-white/10 bg-ink/95 px-5 py-5 backdrop-blur-2xl md:hidden">
